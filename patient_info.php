...
<?php
	...
	if(isset($_POST['save'])) 
	{
        ...
        $sql = "INSERT INTO patient_info(patient_identity ,patient_name ,patient_birth_date ,patient_contact_no,patient_email,
                             patient_parmanent_location,patient_present_location)
                        values('$patient_identity' , '$patient_name' , '$patient_birth_date ' ,'$patient_contact_no' , '$patient_email' , 
                                '$patient_parmanent_location', '$patient_present_location')";
		...
		if($result == 1) 
		{
			...
			header("Location: patient_info_listview.php");
		}
	}
        ...
        <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
              <h4 class="mb"></h4>
              <form class="form-horizontal style-form" method="post" action="patient_info.php">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" name="patient_identity" >
                        </div>
                     </div>
                  ...
                  <div class="form-group">
                          ...
                          <div class="col-sm-6">
                            <input type="text" class="form-control" name="patient_parmanent_location" >
                          </div>
                  </div>
                  <div class="form-group">
                          <label class="col-sm-2 col-sm-2 control-label">Patient Present Address:</label>
                          <div class="col-sm-6">
                            <input type="text" class="form-control" name="patient_present_location" >
                          </div>
                  </div>
